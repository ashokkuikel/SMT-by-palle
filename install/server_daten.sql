...
(2, 'E673A64B-38A1-2F13-C45D-927F207AE309', '21232f297a57a5a743894a0e4a801fc3', 'on', 'adm', '2016-11-10 13:53:37');
...
(2, 'E673A64B-38A1-2F13-C45D-927F207AE309', 'Herr', 'SMT by palle', 'Admin', 'Administrator', 'Admin Administrator (SMT)');

INSERT INTO `db_user_secure` (`id`, `username`, `countLogin`, `authCode`, `lastLogin`, `lastAuthCode`) VALUES
(2, 'E673A64B-38A1-2F13-C45D-927F207AE309', 53, '', '2016-11-10 07:54:13', '0000-00-00 00:00:00');

INSERT INTO `wos_config` (`id`, `value`, `field`) VALUES
('allowed_controller_without_pass', 'cronjob,overview,moin,inventur', 'text'),
('authentication', 'intern', 'text'),
('auto_refresh_servers', '60', 'text'),
('hardware_kategorie', 'Notebook,Telefon,Monitor,Drucker,Externe HDD,Mobiltelefon,Server,Beamer,Sonstiges', 'text'),
('ip_adress_bereich', '192.168.0', 'text'),
('ldap_dn', 'DC=Domain,DC=Endung', 'text'),
('ldap_host', '192.168.0.1', 'text'),
('ldap_manager_group', 'SMT', 'text'),
('ldap_pass', 'ldap_admin_passwort', 'password'),
('ldap_user', 'ldap_admin', 'text'),
('ldap_user_group', 'Users', 'text'),
('ldap_usr_dom', '@domain.endung', 'text'),
('pushover_api_token', 'kein token vorhanden', 'text');
...
(2, 'home_second_nav', 'Physische Systeme', 'sys'),
(3, 'home_third_nav', 'Virtuelle Systeme', 'sys'),
(4, 'home_fourth_nav', 'IT Inventar & Infrastruktur', 'sys'),
...
(65, 'inventory_hardware_date_of_purchase', 'Kaufdatum', 'sys'),
...
(144, 'monitor_status_number_monitoring', 'Anzahl Monitoring', 'sys'),
...
INSERT INTO `wos_submenu` (`id`, `controller`, `controller_ziel`, `methode`, `bezeichnung`, `lfdnr`, `admin`) VALUES
(4, 'server', 'server', 'liste', 'nav_server_liste', 1, 0),
(5, 'server', 'server', 'new', 'nav_server_new', 2, 1),
(7, 'vmware', 'vmware', 'liste', 'nav_vmware_liste', 1, 0),
(9, 'monitor', 'cronjob', 'updater/update', 'nav_home_updater', 1, 0),
(11, 'home', 'cronjob', 'updater/update', 'nav_home_updater', 1, 0),
(12, 'inventory', 'inventory', 'dnscheck', 'nav_inventar_dns', 6, 0),
(14, 'server', 'cronjob', 'updater/update', 'nav_home_updater', 4, 0),
(15, 'vmware', 'vmware', 'new', 'nav_vmware_new', 2, 1),
(16, 'vmware', 'cronjob', 'updater/update', 'nav_home_updater', 4, 0),
(17, 'inventory', 'inventory', 'services', 'nav_inventar_services', 4, 0),
(22, 'inventory', 'inventory', 'ipadressen', 'nav_inventar_ip', 7, 0),
(23, 'inventory', 'inventory', 'servicelog', 'nav_inventar_logfile', 5, 0),
(24, 'inventory', 'inventory', 'license', 'nav_inventar_license', 1, 1),
(25, 'inventory', 'inventory', 'hardware', 'nav_inventar_hardware', 2, 0),
(26, 'inventory', 'inventur', '', 'nav_inventur', 3, 0);

INSERT INTO `wos_tcp_port` (`port`, `bezeichnung`, `beschreibung`) VALUES
